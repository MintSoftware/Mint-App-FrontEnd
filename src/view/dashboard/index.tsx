      ...
      <div className="flex flex-col min-h-screen">
        <section className="relative h-[500px] overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center text-white">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">Alugue as Melhores Quadras de Futebol</h1>
        ...
        <div className="bg-gray-100 p-4 lg:p-8">
          <h2 className="text-2xl font-bold mb-4">Filtrar Quadras</h2>
            ...
            <div>
              ...
              <Carousel className="w-full">
                <CarouselContent>
                  ...
                  <CarouselItem>
                      <SelectTrigger>
                        <SelectValue placeholder="Zona Alta" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="downtown">Centro</SelectItem>
                        <SelectItem value="uptown">Zona Alta</SelectItem>
                  ...
                  <CarouselItem>
                      <SelectTrigger>
                        <SelectValue placeholder="Subúrbio" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="downtown">Centro</SelectItem>
                        <SelectItem value="uptown">Zona Alta</SelectItem>
